...
# tries to move to the bottom-right corner 
...
# Input: m = 3, n = 2
# Output: 3
# Explanation: From the top-left corner, there are a total 
# of 3 ways to reach the bottom-right corner:
    # 1. Right -> Down -> Down
    # 2. Down -> Down -> Right
    # 3. Down -> Right -> Down
...
m2 = 3
n2 = 2
print(Solution().uniquePaths(m2,n2)) # 3
